...
public class Wifi : MonoBehaviour {
	...
	IEnumerator Upload() {
		...
		Person panos = new Person(); //Object created of the class that contains the varaibles that will stoee the data
		...
		UnityWebRequest www = UnityWebRequest.Post("mhml.greenberg.io/stress", form); //We Post (i.e.) send the form containing the json message to the API
