...
public class receive : MonoBehaviour {	
		public void Upload(){ //Function attached to a button on the app to retreive data from the API
			StartCoroutine(GetText());
		}

		IEnumerator GetText() {
			UnityWebRequest www = UnityWebRequest.Get("mhml.greenberg.io/stress"); //Get request to API
